      ...
      <a-col :span="8">
        <a-card class="profile-card">
          <div class="avatar-section">
            <a-avatar :size="80" style="backgroundColor: #00c9b7; fontSize: 32px">{{ store.user.name[0] }}</a-avatar>
            <h3>{{ store.user.name }}</h3>
            <p>{{ store.user.position }}</p>
          </div>
          <a-divider />
          <a-descriptions :column="1" size="small">
            <a-descriptions-item label="部门">{{ store.user.department }}</a-descriptions-item>
            <a-descriptions-item label="岗位">{{ store.user.position }}</a-descriptions-item>
            <a-descriptions-item label="邮箱">zhang.ming@company.com</a-descriptions-item>
            <a-descriptions-item label="手机">138****5678</a-descriptions-item>
            <a-descriptions-item label="授权范围">全部应用</a-descriptions-item>
            <a-descriptions-item label="数据权限">本人数据</a-descriptions-item>
          </a-descriptions>
          <a-divider />
          <a-card title="偏好设置" :bordered="false" size="small" class="pref-card">
            <a-form layout="vertical" size="small">
              <a-form-item label="语言">
                <a-select :value="'zh-CN'" style="width: 100%">
                  <a-select-option value="zh-CN">简体中文</a-select-option>
                  <a-select-option value="en-US">English</a-select-option>
                </a-select>
              </a-form-item>
              <a-form-item label="通知偏好">
                <a-checkbox :checked="true">任务完成</a-checkbox>
                <a-checkbox :checked="true" style="margin-left: 8px">异常告警</a-checkbox>
                <a-checkbox :checked="false" style="margin-left: 8px">营销消息</a-checkbox>
              </a-form-item>
            </a-form>
          </a-card>
        </a-card>
