...
export const mockApplications: ApplicationItem[] = [
  { id: 'ff1e69b2-ddfd-4406-b8f9-024db34081cd', name: '规范问答', category: 'general', manager: '李文', version: 'v2.1.0', status: 'online', userCount: 1240, apiCalls: 256000, createdAt: '2026-01-15', icon: 'BookOutlined', route: '/applications/standard', grantedRoles: ['admin', 'tester'] },
  ...
  { id: '951ee79b-247e-4473-88a1-19e91c6d40ed', name: '情报采集', category: 'operation', manager: '王琳', version: 'v1.2.0', status: 'online', userCount: 180, apiCalls: 34000, createdAt: '2026-04-15', icon: 'RadarChartOutlined', route: '/applications/intelligence', subApps: [
    { id: '5c264893-1107-4de1-800a-52c178b9923f', name: '疏浚情报', category: 'operation', parentAppId: '951ee79b-247e-4473-88a1-19e91c6d40ed', route: '/intelligence/dredge', icon: 'RadarChartOutlined', version: 'v1.0.0', status: 'published', description: '聚焦疏浚行业的科技与工程情报，由后台采集并结构化后发布', grantedRoles: ['ops'] },
