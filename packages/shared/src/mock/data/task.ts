...
export const taskItems: TaskItem[] = [
  ...
  { id: '2', title: 'GB/T 19001 条款匹配检查', status: '已完成', updatedAt: '2026-07-16 16:08', app: '规范问答', progress: 100 },
...
export const quickTasks = [
  { id: 'qt-1', title: '开始AI投标', tag: '经营', route: '/ai-bid', icon: 'FileSearchOutlined' },
