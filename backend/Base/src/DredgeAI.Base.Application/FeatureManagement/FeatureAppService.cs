...
namespace DredgeAI.FeatureManagement;

[Dependency(ReplaceServices = true)]
[ExposeServices(typeof(IFeatureAppService))]
public class FeatureAppService : DredgeAIBaseAppService, IFeatureAppService
{
    ...
    protected virtual async Task CheckProviderPolicy(string providerName, string providerKey)
    {
        ...
        {
            policyName = DredgeAIBasePermissions.Features.ManageHostFeatures;
        }
        else
        {
