...
namespace DredgeAI.BidCompare.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("BidCompare") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "BidCompare", DisplayName = "BidCompare API", Resources = { "BidCompare" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var swaggerRootUrl = configurationSection["BidCompare_Swagger:RootUrl"]?.TrimEnd('/');
