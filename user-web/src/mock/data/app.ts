 ...
 * 分类：基础(3) | 设计(2) | 施工(3) | 经营(2)
 */
export const appCards: AppCard[] = [
  { id: '1', title: '智能审批助手', description: 'AI 辅助日常审批流程，自动识别关键节点', category: '基础', icon: 'AuditOutlined', status: '已授权', route: '/approval', version: 'v2.3.1', pinned: false },
  { id: '2', title: '知识检索系统', description: '基于企业知识库的智能问答与文档检索', category: '基础', icon: 'SearchOutlined', status: '已授权', route: '/knowledge', version: 'v1.8.0', pinned: true },
  ...
  { id: '7', title: '图纸合规检查', description: '智能识别施工图纸与设计规范的偏差', category: '设计', icon: 'EditOutlined', status: '已授权', route: '/standards', version: 'v1.4.0', pinned: true },
  ...
  { id: '10', title: '知识问答', description: '基于企业知识库的智能问答与文档检索', category: '基础', icon: 'QuestionCircleOutlined', status: '已授权', route: '/qa', version: 'v2.0.0', pinned: false },
]
